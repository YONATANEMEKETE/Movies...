...
const Hero = () => {
  return (
    <div className="relative -z-10 h-full mx-12 min-[1100px]:mx-4 mt-[12rem] min-[1100px]:mt-4">
      ...
      overflow-hidden shadow-2xl drop-shadow-xl mb-12 rounded-lg"
        autoplay={{
          delay: 4500,
      ...
      <div
       ...
       mx-auto w-3/4 min-[1100px]:absolute z-20 min-[1100px]:left-8 min-[1100px]:bottom-[20%] min-[1100px]:text-start 
